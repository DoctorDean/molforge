...
Concrete engines:
    ...
    - :class:`Boltz` — implemented (Boltz-1 / Boltz-2 via subprocess;
      AlphaFold-3-style multi-component prediction)
    - :class:`Chai1` — implemented (Chai-1 via Python API; AlphaFold-3-
      style multi-component prediction; natural cross-check for Boltz)
...
Shared:
    ...
    - :class:`FoldingEngineNotInstalledError` — raised when heavy
      ...
      chai_lab, the RFAA repo + databases, ...) aren't installed.
...
from molforge.wrappers.folding.chai import Chai1
